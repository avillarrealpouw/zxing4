...
public final class PDF417 {
  ...
  public void generateBarcodeLogic(String msg, int errorCorrectionLevel, boolean autoECI) throws WriterException {
    ...
    //System.out.println("Message Length: "+msg.length()+" compaction "+compaction.toString()+" encoding "+encoding.toString()+
    //    " autoECI "+autoECI);
    //System.out.println("high level size: "+sourceCodeWords+" error correction code words: "+errorCorrectionCodeWords);
    ...
    System.out.println("error correction length: "+ec.length());
